...
const HeaderMain: React.FC<HeaderMainProps> = ({ onCategorySelect }) => {
    ...
    return (
        <div className="border-b border-gray-200 py-4 bg-white shadow-md">
            <div className="container mx-auto flex justify-between items-center px-4">
                <div className="flex items-center space-x-4">
                    <Image src="/images/luxaris.png" alt="logo luxaris" width={192} height={48} className="w-32" />
                ...
                <div className="flex items-center space-x-4">
                    <input
                        className="search_input w-full px-4 py-2 rounded-md border border-gray-300 shadow-sm focus:outline-none focus:border-accent"
                        type="text"
                        placeholder="Buscar..."
                    />
